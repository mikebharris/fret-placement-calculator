...
func Test_ShouldReturnFretPlacementsForFiveLimitJustScaleFromPureRatiosOverTwoOctaves(t *testing.T) {
	...
	assert.Equal(t, handler.Fret{Label: "1:1", Position: 0, Comment: "Perfect Unison", Interval: "1:1"}, fretboard.Frets[0])
	assert.Equal(t, handler.Fret{Label: "16:15", Position: 33.75, Comment: "Minor Second", Interval: "16:15"}, fretboard.Frets[1])
	assert.Equal(t, handler.Fret{Label: "9:8", Position: 60.0, Comment: "Pythagorean (Greater) Major Second", Interval: "135:128"}, fretboard.Frets[2])
	assert.Equal(t, handler.Fret{Label: "6:5", Position: 90.0, Comment: "Minor Third", Interval: "16:15"}, fretboard.Frets[3])
	assert.Equal(t, handler.Fret{Label: "5:4", Position: 108.0, Comment: "Major Third", Interval: "25:24"}, fretboard.Frets[4])
	assert.Equal(t, handler.Fret{Label: "4:3", Position: 135.0, Comment: "Perfect Fourth", Interval: "16:15"}, fretboard.Frets[5])
	assert.Equal(t, handler.Fret{Label: "45:32", Position: 156.0, Comment: "Augmented Fourth", Interval: "135:128"}, fretboard.Frets[6])
	assert.Equal(t, handler.Fret{Label: "3:2", Position: 180.0, Comment: "Perfect Fifth", Interval: "16:15"}, fretboard.Frets[7])
	assert.Equal(t, handler.Fret{Label: "8:5", Position: 202.5, Comment: "Just Minor Sixth", Interval: "16:15"}, fretboard.Frets[8])
	assert.Equal(t, handler.Fret{Label: "5:3", Position: 216.0, Comment: "Major Sixth", Interval: "25:24"}, fretboard.Frets[9])
	assert.Equal(t, handler.Fret{Label: "9:5", Position: 240.0, Comment: "Just (Greater) Minor Seventh", Interval: "27:25"}, fretboard.Frets[10])
	assert.Equal(t, handler.Fret{Label: "15:8", Position: 252.0, Comment: "Just Major Seventh", Interval: "25:24"}, fretboard.Frets[11])
	assert.Equal(t, handler.Fret{Label: "2:1", Position: 270.0, Comment: "Perfect Octave", Interval: "16:15"}, fretboard.Frets[12])
	assert.Equal(t, handler.Fret{Label: "16:15", Position: 286.88, Comment: "Minor Second", Interval: "16:15"}, fretboard.Frets[13])
	assert.Equal(t, handler.Fret{Label: "9:8", Position: 300.0, Comment: "Pythagorean (Greater) Major Second", Interval: "135:128"}, fretboard.Frets[14])
	assert.Equal(t, handler.Fret{Label: "6:5", Position: 315.0, Comment: "Minor Third", Interval: "16:15"}, fretboard.Frets[15])
	assert.Equal(t, handler.Fret{Label: "5:4", Position: 324.0, Comment: "Major Third", Interval: "25:24"}, fretboard.Frets[16])
	assert.Equal(t, handler.Fret{Label: "4:3", Position: 337.5, Comment: "Perfect Fourth", Interval: "16:15"}, fretboard.Frets[17])
	assert.Equal(t, handler.Fret{Label: "45:32", Position: 348.0, Comment: "Augmented Fourth", Interval: "135:128"}, fretboard.Frets[18])
	assert.Equal(t, handler.Fret{Label: "3:2", Position: 360.0, Comment: "Perfect Fifth", Interval: "16:15"}, fretboard.Frets[19])
	assert.Equal(t, handler.Fret{Label: "8:5", Position: 371.25, Comment: "Just Minor Sixth", Interval: "16:15"}, fretboard.Frets[20])
	assert.Equal(t, handler.Fret{Label: "5:3", Position: 378.0, Comment: "Major Sixth", Interval: "25:24"}, fretboard.Frets[21])
	assert.Equal(t, handler.Fret{Label: "9:5", Position: 390.0, Comment: "Just (Greater) Minor Seventh", Interval: "27:25"}, fretboard.Frets[22])
	assert.Equal(t, handler.Fret{Label: "15:8", Position: 396.0, Comment: "Just Major Seventh", Interval: "25:24"}, fretboard.Frets[23])
	assert.Equal(t, handler.Fret{Label: "2:1", Position: 405.0, Comment: "Perfect Octave", Interval: "16:15"}, fretboard.Frets[24])
}
...
func Test_ShouldReturnFretPlacementsForQuarterCommaMeantoneScale(t *testing.T) {
	...
	assert.Equal(t, 14, len(fretboard.Frets))
	assert.Equal(t, handler.Fret{Label: "117.13 cents", Position: 35.33}, fretboard.Frets[1])
}
...
func Test_ShouldReturnFretPlacementsForExtendedQuarterCommaMeantoneScale(t *testing.T) {
	...
	assert.Equal(t, handler.Fret{Label: "76.20 cents", Position: 23.25}, fretboard.Frets[1])
	assert.Equal(t, handler.Fret{Label: "117.13 cents", Position: 35.33}, fretboard.Frets[2])
}
...
func Test_ShouldReturnEqualTemperamentPlacementsWithCustomDivisions(t *testing.T) {
	...
	assert.Equal(t, 13, len(fretboard.Frets))
	assert.Equal(t, handler.Fret{Label: "0.00 cents", Position: 0}, fretboard.Frets[0])
	assert.Equal(t, handler.Fret{Label: "100.00 cents", Position: 33.68}, fretboard.Frets[1])
	assert.Equal(t, handler.Fret{Label: "200.00 cents", Position: 65.46}, fretboard.Frets[2])
	assert.Equal(t, handler.Fret{Label: "300.00 cents", Position: 95.46}, fretboard.Frets[3])
	assert.Equal(t, handler.Fret{Label: "400.00 cents", Position: 123.78}, fretboard.Frets[4])
	assert.Equal(t, handler.Fret{Label: "500.00 cents", Position: 150.51}, fretboard.Frets[5])
	assert.Equal(t, handler.Fret{Label: "600.00 cents", Position: 175.74}, fretboard.Frets[6])
	assert.Equal(t, handler.Fret{Label: "700.00 cents", Position: 199.55}, fretboard.Frets[7])
	assert.Equal(t, handler.Fret{Label: "800.00 cents", Position: 222.02}, fretboard.Frets[8])
	assert.Equal(t, handler.Fret{Label: "900.00 cents", Position: 243.24}, fretboard.Frets[9])
	assert.Equal(t, handler.Fret{Label: "1000.00 cents", Position: 263.26}, fretboard.Frets[10])
	assert.Equal(t, handler.Fret{Label: "1100.00 cents", Position: 282.16}, fretboard.Frets[11])
	assert.Equal(t, handler.Fret{Label: "1200.00 cents", Position: 300.0}, fretboard.Frets[12])
}
...
func Test_ShouldReturnMultipleOctavesOfFretsIfSpecified(t *testing.T) {
	...
	assert.Equal(t, handler.Fret{Label: "1100.00 cents", Position: 282.16}, fretboard.Frets[11])
	assert.Equal(t, handler.Fret{Label: "1200.00 cents", Position: 300.0}, fretboard.Frets[12])
	assert.Equal(t, handler.Fret{Label: "1300.00 cents", Position: 316.84}, fretboard.Frets[13])
	assert.Equal(t, handler.Fret{Label: "2400.00 cents", Position: 450.0}, fretboard.Frets[24])
}
